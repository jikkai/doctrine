...
the Pagefind development data is rebuilt lazily after the next search request.

## `doctrine build`

Builds the client and SSR bundles, prerenders every navigation route, writes `404.html`, and creates
the Pagefind index.
